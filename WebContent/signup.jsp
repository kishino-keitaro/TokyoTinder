...
<body onload="dateCheck('year', 'month', 'day');">
	...
	<form id="form" method="post" action="controllers/Registration">
		...
		<li class="password2"><label for="password2">Password(確認用)*</label>
			<input "validate[required,equals[passwd]] text-input" type="password"
			id="reepass" placeholder="Password確認用" size="60">
			<p>※半角英数字4～16文字以内</p></li>
		...
		</select><label for="year">年</label> <select name="month"
		...
		</select><label for="month">月</label> <select name="day">
				<!-- 作動時に中身を変更-->
				<option value="1" selected="selected">1</option>
				<option value="2">2</option>
				<option value="3">3</option>
		...
		</select><label for="day">日</label> <!--プロフィール--> <!--自己プロフィール-->
...
ユーザー登録後に設定することも可能です。" "ID" cols="62"
