...
<body onload="dateCheck('year', 'month', 'day');">
	...
	<form id="form" method="post" action="controllers/Registration">
		...
		<!-- アップロード開始ボタン -->
		<button class="btn btn-primary" id="upload">画像をアップロード</button>
  ...
  $('#upload').click(function(){
    ...
    .fail(function( jqXHR, textStatus, errorThrown ) {
      // 送信失敗
		...
		<p>※画像の最大サイズ：700KB 対応フォーマットはGIF、JPEG、PNGです。</p>
		<!--名前-->
		<p>
			名前* <input type="text" name="name" value="ユーザー名"
				class="validate[required,minSize[4],maxSize[16]]">
		</p>

		<!--性別-->
		<p>
			性別<INPUT TYPE="radio" NAME="sex" VALUE="m">男 <INPUT
				TYPE="radio" NAME="sex" VALUE="f" checked>女
		</p>
		...
		<!--パスワード-->
		<p>
			Password* <input type="password" name="pass" id="passwd"
		...
		<!--パスワード確認用-->
		<p>
			Password(確認用)* <input type="password" id="reepass"
				class="validate[required,equals[passwd]] text-input">
		</p>
		<p>※半角英数字4～16文字以内</p>

		<!--年齢-->
		<p>生年月日</p>
<select name="year"  onchange="dateCheck('year', 'month', 'day')"> <!-- 選択時にjavascript作動-->
...
<select name="day"> <!-- 作動時に中身を変更-->
  ...
  <option value="31">31</option>
		...
		<textarea NAME="comment" COLS="50" ROWS="8"
			class="validate[maxSize[150]]">
プロフィールを入力してください。
ユーザー登録後に設定することも可能です。</textarea>
		...
		<a href="LoginForm.jsp" class="button2">もどる</a>
	</form>
</body>
</html>